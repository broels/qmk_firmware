...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
               ...
               KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_SLSH, KC_N, KC_M, KC_COMM, KC_DOT, KC_RSFT, MO(3),
  ...
  [1] = LAYOUT(
               ...
               KC_LSPO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_SLSH, KC_N, KC_M, KC_COMM, KC_DOT, KC_RSPC, MO(3),
               KC_NO, KC_LGUI, KC_LALT, LCTL_T(KC_SPC), KC_RALT, KC_RGUI, KC_NO
               ),
  ...
  [2] = LAYOUT(
               ...
               KC_LSPO, KC_Z, KC_X, KC_C, KC_D, KC_V, KC_SLSH, KC_M, KC_H, KC_COMM, KC_DOT, KC_RSPC, MO(3),
               KC_NO, KC_LGUI, KC_LALT, LCTL_T(KC_SPC), KC_RALT, KC_RGUI, KC_NO
               ),

  [3] = LAYOUT(
               KC_NO, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_NO, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_SLEP,
