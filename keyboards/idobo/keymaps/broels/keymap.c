 ...
 */
 ...
 [_QW] = LAYOUT_ortho_5x15( /* QWERTY */
    ...
    LCTL_T(KC_BSPC), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_HOME, KC_DEL,  KC_PGUP, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT, \
    KC_LSPO, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_END,  KC_UP,   KC_PGDN, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC, \
    KC_LCTL, KC_LGUI, KC_LALT, MO(_FN), KC_SPC,  LCTL_T(KC_SPC),  KC_LEFT, KC_DOWN, KC_RGHT, LCTL_T(KC_SPC),  KC_SPC,  MO(_FN), KC_RALT, KC_RGUI, KC_RCTL  \
 ),
